 ...
 * :[-1, 0, 1, 2, 3, 4, 5, 6, 7]
 */
// serial port used by the tft screen
...
#define CUSTOM_MACHINE_NAME "Big Bird"

// Printer's unique ID, used by some programs to differentiate between machines.
// Choose your own or use a service like https://www.uuidgenerator.net/version4
//#define MACHINE_UUID "f5bdcfe5-88b7-403e-8979-de3d1ee94fe2"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #define DEFAULT_Kp_LIST { 15.14}
  #define DEFAULT_Ki_LIST {  1.68}
  #define DEFAULT_Kd_LIST { 34.10}
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // Flyingbear Tornado 2 Pro
  #define DEFAULT_bedKp  97.33
  #define DEFAULT_bedKi  16.28
  #define DEFAULT_bedKd 388.07
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 800, 791, 396 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -38, -19, -0.38 }
...
#define FILAMENT_RUNOUT_SENSOR
  ...
  #define FIL_RUNOUT_PIN 2    // this is the xmax pin, which is used for the run out sensor
  #if EXTRUDERS>1
    #define FIL_RUNOUT2_PIN 15   // this is the ymax pin, which is used for the run out sensor
  #endif
