 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 800, 384 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -38, -19, -3 }
...
#define FILAMENT_RUNOUT_SENSOR
  ...
  #if EXTRUDERS>1
    #define FIL_RUNOUT2_PIN 19   // this is the zmax pin, which is used for the run out sensor
  #endif
