...
// Heaters
#if PIN_EXISTS(TOOL_0_HEATER)
  #define HAS_HEATER_0 1
#endif
#if PIN_EXISTS(TOOL_1_HEATER)
  #define HAS_HEATER_1 1
#endif
#if PIN_EXISTS(TOOL_2_HEATER)
  #define HAS_HEATER_2 1
#endif
#if PIN_EXISTS(TOOL_3_HEATER)
  #define HAS_HEATER_3 1
#endif
#if PIN_EXISTS(TOOL_4_HEATER)
  #define HAS_HEATER_4 1
#endif
#if PIN_EXISTS(TOOL_5_HEATER)
  #define HAS_HEATER_5 1
#endif
#if PIN_EXISTS(TOOL_6_HEATER)
  #define HAS_HEATER_6 1
#endif
#if PIN_EXISTS(TOOL_7_HEATER)
 ...
 */
#define WRITE_HEATER_0P(v) WRITE(TOOL_0_HEATER_PIN, (v) ^ ENABLED(HEATER_0_INVERTING))
#if ANY(HAS_MULTI_HOTEND, HEATERS_PARALLEL)
  #define WRITE_HEATER_1(v) WRITE(TOOL_1_HEATER_PIN, (v) ^ ENABLED(HEATER_1_INVERTING))
  #if HOTENDS > 2
    #define WRITE_HEATER_2(v) WRITE(TOOL_2_HEATER_PIN, (v) ^ ENABLED(HEATER_2_INVERTING))
    #if HOTENDS > 3
      #define WRITE_HEATER_3(v) WRITE(TOOL_3_HEATER_PIN, (v) ^ ENABLED(HEATER_3_INVERTING))
      #if HOTENDS > 4
        #define WRITE_HEATER_4(v) WRITE(TOOL_4_HEATER_PIN, (v) ^ ENABLED(HEATER_4_INVERTING))
        #if HOTENDS > 5
          #define WRITE_HEATER_5(v) WRITE(TOOL_5_HEATER_PIN, (v) ^ ENABLED(HEATER_5_INVERTING))
          #if HOTENDS > 6
            #define WRITE_HEATER_6(v) WRITE(TOOL_6_HEATER_PIN, (v) ^ ENABLED(HEATER_6_INVERTING))
            #if HOTENDS > 7
              #define WRITE_HEATER_7(v) WRITE(TOOL_7_HEATER_PIN, (v) ^ ENABLED(HEATER_7_INVERTING))
            #endif // HOTENDS > 7
          #endif // HOTENDS > 6
        #endif // HOTENDS > 5
      #endif // HOTENDS > 4
