 ...
 */
  ...
  // Check stepper overrides only for TMC drivers
  #define __LOOKUP_STEPPER_DRIVER(N) E##N
  #define _LOOKUP_STEPPER_DRIVER(N) __LOOKUP_STEPPER_DRIVER(N)
  #define LOOKUP_STEPPER_DRIVER(N) _LOOKUP_STEPPER_DRIVER(TOOL_##N##_E_STEPPER)
  #if TERN0(TOOL_0_STEPPER_OVERRIDE, !AXIS_IS_TMC(LOOKUP_STEPPER_DRIVER(0)))
    #error "TOOL_0_STEPPER_OVERRIDE requires E0_DRIVER_TYPE to be a TMC driver"
  #endif
  #if TERN0(TOOL_1_STEPPER_OVERRIDE, !AXIS_IS_TMC(LOOKUP_STEPPER_DRIVER(1)))
    #error "TOOL_1_STEPPER_OVERRIDE requires E1_DRIVER_TYPE to be a TMC driver"
  #endif
  #if TERN0(TOOL_2_STEPPER_OVERRIDE, !AXIS_IS_TMC(LOOKUP_STEPPER_DRIVER(2)))
    #error "TOOL_2_STEPPER_OVERRIDE requires E2_DRIVER_TYPE to be a TMC driver"
  #endif
  #if TERN0(TOOL_3_STEPPER_OVERRIDE, !AXIS_IS_TMC(LOOKUP_STEPPER_DRIVER(3)))
    #error "TOOL_3_STEPPER_OVERRIDE requires E3_DRIVER_TYPE to be a TMC driver"
  #endif
  #if TERN0(TOOL_4_STEPPER_OVERRIDE, !AXIS_IS_TMC(LOOKUP_STEPPER_DRIVER(4)))
    #error "TOOL_4_STEPPER_OVERRIDE requires E4_DRIVER_TYPE to be a TMC driver"
  #endif
  #if TERN0(TOOL_5_STEPPER_OVERRIDE, !AXIS_IS_TMC(LOOKUP_STEPPER_DRIVER(5)))
    #error "TOOL_5_STEPPER_OVERRIDE requires E5_DRIVER_TYPE to be a TMC driver"
  #endif
  #if TERN0(TOOL_6_STEPPER_OVERRIDE, !AXIS_IS_TMC(LOOKUP_STEPPER_DRIVER(6)))
    #error "TOOL_6_STEPPER_OVERRIDE requires E6_DRIVER_TYPE to be a TMC driver"
  #endif
  #if TERN0(TOOL_7_STEPPER_OVERRIDE, !AXIS_IS_TMC(LOOKUP_STEPPER_DRIVER(7)))
    #error "TOOL_7_STEPPER_OVERRIDE requires E7_DRIVER_TYPE to be a TMC driver"
  #endif
 ...
 */
  ...
  #elif !ANY_PIN(TOOL_0_TEMP, TEMP_0_CS) && !TEMP_SENSOR_0_IS_DUMMY
    ...
    #error "HEATER_1_PIN is not defined. TEMP_SENSOR_1 might not be set, or the board (not EEB / EEF?) doesn't define a pin."
    ...
    #elif !ANY_PIN(TOOL_1_TEMP, TEMP_1_CS) && !TEMP_SENSOR_1_IS_DUMMY
      #error "TEMP_1_PIN or TEMP_1_CS_PIN not defined for this board."
      ...
      #elif !ANY_PIN(TOOL_2_TEMP, TEMP_2_CS) && !TEMP_SENSOR_2_IS_DUMMY
        #error "TEMP_2_PIN or TEMP_2_CS_PIN not defined for this board."
        ...
        #elif !PIN_EXISTS(TOOL_3_TEMP) && !TEMP_SENSOR_3_IS_DUMMY
          #error "TEMP_3_PIN not defined for this board."
          ...
          #elif !PIN_EXISTS(TOOL_4_TEMP) && !TEMP_SENSOR_4_IS_DUMMY
            #error "TEMP_4_PIN not defined for this board."
            ...
            #elif !PIN_EXISTS(TOOL_5_TEMP) && !TEMP_SENSOR_5_IS_DUMMY
              #error "TEMP_5_PIN not defined for this board."
              ...
              #elif !PIN_EXISTS(TOOL_6_TEMP) && !TEMP_SENSOR_6_IS_DUMMY
                #error "TEMP_6_PIN not defined for this board."
                  ...
                  #error "TEMP_SENSOR_7 is required with 8 HOTENDS."
                #elif !HAS_HEATER_7
                  #error "HEATER_7_PIN not defined for this board."
                #elif !PIN_EXISTS(TOOL_7_TEMP) && !TEMP_SENSOR_7_IS_DUMMY
 ...
 */
    ...
    #error "E0_STEP_PIN, E0_DIR_PIN, or E0_ENABLE_PIN not defined for this board."
  #endif
  #if E_STEPPERS > 1 && TERN1(MANUAL_SWITCHING_TOOLHEAD, E_DRIVERS > 1)
    #if !(PINS_EXIST(E1_STEP, E1_DIR) && HAS_E1_ENABLE)
      #error "E1_STEP_PIN, E1_DIR_PIN, or E1_ENABLE_PIN not defined for this board."
    #endif
    #if E_STEPPERS > 2 && TERN1(MANUAL_SWITCHING_TOOLHEAD, E_DRIVERS > 2)
      #if !(PINS_EXIST(E2_STEP, E2_DIR) && HAS_E2_ENABLE)
        #error "E2_STEP_PIN, E2_DIR_PIN, or E2_ENABLE_PIN not defined for this board."
      #endif
      #if E_STEPPERS > 3 && TERN1(MANUAL_SWITCHING_TOOLHEAD, E_DRIVERS > 3)
        #if !(PINS_EXIST(E3_STEP, E3_DIR) && HAS_E3_ENABLE)
          #error "E3_STEP_PIN, E3_DIR_PIN, or E3_ENABLE_PIN not defined for this board."
        #endif
        #if E_STEPPERS > 4 && TERN1(MANUAL_SWITCHING_TOOLHEAD, E_DRIVERS > 4)
          #if !(PINS_EXIST(E4_STEP, E4_DIR) && HAS_E4_ENABLE)
            #error "E4_STEP_PIN, E4_DIR_PIN, or E4_ENABLE_PIN not defined for this board."
          #endif
          #if E_STEPPERS > 5 && TERN1(MANUAL_SWITCHING_TOOLHEAD, E_DRIVERS > 5)
            #if !(PINS_EXIST(E5_STEP, E5_DIR) && HAS_E5_ENABLE)
              #error "E5_STEP_PIN, E5_DIR_PIN, or E5_ENABLE_PIN not defined for this board."
            #endif
            #if E_STEPPERS > 6 && TERN1(MANUAL_SWITCHING_TOOLHEAD, E_DRIVERS > 6)
              #if !(PINS_EXIST(E6_STEP, E6_DIR) && HAS_E6_ENABLE)
                #error "E6_STEP_PIN, E6_DIR_PIN, or E6_ENABLE_PIN not defined for this board."
              #endif
              #if E_STEPPERS > 7 && TERN1(MANUAL_SWITCHING_TOOLHEAD, E_DRIVERS > 7)
