 ...
 */
  ...
  // Always switch to specific tool when homing; comment out to disable.
  #define TOOLCHANGE_HOMING_TOOL 0
  ...
  //#define TOOLCHANGE_FILAMENT_SWAP
    ...
    // #define TOOL_0_STEPPER_OVERRIDE
    #if ENABLED(TOOL_0_STEPPER_OVERRIDE)
      #define TOOL_0_E_CURRENT          800
      #define TOOL_0_E_MICROSTEPS       E0_MICROSTEPS
      #define TOOL_0_E_INTERPOLATE      E0_INTERPOLATE
      #define TOOL_0_E_HOLD_MULTIPLIER  E0_HOLD_MULTIPLIER
      #define TOOL_0_E_HYBRID_THRESHOLD E0_HYBRID_THRESHOLD
    #endif
    // #define TOOL_1_STEPPER_OVERRIDE
    #if ENABLED(TOOL_1_STEPPER_OVERRIDE)
      #define TOOL_1_E_CURRENT          800
      #define TOOL_1_E_MICROSTEPS       E0_MICROSTEPS
      #define TOOL_1_E_INTERPOLATE      E0_INTERPOLATE
      #define TOOL_1_E_HOLD_MULTIPLIER  E0_HOLD_MULTIPLIER
      #define TOOL_1_E_HYBRID_THRESHOLD E0_HYBRID_THRESHOLD
    #endif
    // #define TOOL_2_STEPPER_OVERRIDE
    #if ENABLED(TOOL_2_STEPPER_OVERRIDE)
      #define TOOL_2_E_CURRENT          800
      #define TOOL_2_E_MICROSTEPS       E0_MICROSTEPS
      #define TOOL_2_E_INTERPOLATE      E0_INTERPOLATE
      #define TOOL_2_E_HOLD_MULTIPLIER  E0_HOLD_MULTIPLIER
      #define TOOL_2_E_HYBRID_THRESHOLD E0_HYBRID_THRESHOLD
    #endif
    // #define TOOL_3_STEPPER_OVERRIDE
    #if ENABLED(TOOL_3_STEPPER_OVERRIDE)
      #define TOOL_3_E_CURRENT          800
      #define TOOL_3_E_MICROSTEPS       E0_MICROSTEPS
      #define TOOL_3_E_INTERPOLATE      E0_INTERPOLATE
      #define TOOL_3_E_HOLD_MULTIPLIER  E0_HOLD_MULTIPLIER
      #define TOOL_3_E_HYBRID_THRESHOLD E0_HYBRID_THRESHOLD
    #endif
    // #define TOOL_4_STEPPER_OVERRIDE
    #if ENABLED(TOOL_4_STEPPER_OVERRIDE)
      #define TOOL_4_E_CURRENT          800
      #define TOOL_4_E_MICROSTEPS       E0_MICROSTEPS
      #define TOOL_4_E_INTERPOLATE      E0_INTERPOLATE
      #define TOOL_4_E_HOLD_MULTIPLIER  E0_HOLD_MULTIPLIER
      #define TOOL_4_E_HYBRID_THRESHOLD E0_HYBRID_THRESHOLD
    #endif
    // #define TOOL_5_STEPPER_OVERRIDE
    #if ENABLED(TOOL_5_STEPPER_OVERRIDE)
      #define TOOL_5_E_CURRENT          800
      #define TOOL_5_E_MICROSTEPS       E0_MICROSTEPS
      #define TOOL_5_E_INTERPOLATE      E0_INTERPOLATE
      #define TOOL_5_E_HOLD_MULTIPLIER  E0_HOLD_MULTIPLIER
      #define TOOL_5_E_HYBRID_THRESHOLD E0_HYBRID_THRESHOLD
    #endif
    // #define TOOL_6_STEPPER_OVERRIDE
    #if ENABLED(TOOL_6_STEPPER_OVERRIDE)
      #define TOOL_6_E_CURRENT          800
      #define TOOL_6_E_MICROSTEPS       E0_MICROSTEPS
      #define TOOL_6_E_INTERPOLATE      E0_INTERPOLATE
      #define TOOL_6_E_HOLD_MULTIPLIER  E0_HOLD_MULTIPLIER
      #define TOOL_6_E_HYBRID_THRESHOLD E0_HYBRID_THRESHOLD
    #endif
    // #define TOOL_7_STEPPER_OVERRIDE
    #if ENABLED(TOOL_7_STEPPER_OVERRIDE)
      #define TOOL_7_E_CURRENT          800
      #define TOOL_7_E_MICROSTEPS       E0_MICROSTEPS
      #define TOOL_7_E_INTERPOLATE      E0_INTERPOLATE
      #define TOOL_7_E_HOLD_MULTIPLIER  E0_HOLD_MULTIPLIER
      #define TOOL_7_E_HYBRID_THRESHOLD E0_HYBRID_THRESHOLD
    #endif
  #endif

  /**
   * Position to park head during tool change.
   * Doesn't apply to SERVO_SWITCHING_TOOLHEAD, DUAL_X_CARRIAGE, or PARKING_EXTRUDER
   */
